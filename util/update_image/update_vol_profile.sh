...
profile_file='/usr/local/lib/python2.7/dist-packages/volatility-2.6.1-py2.7.egg/volatility/plugins/overlays/linux/Ubuntu1404.zip'
rm -rf $profile_file
zip /usr/local/lib/python2.7/dist-packages/volatility-2.6.1-py2.7.egg/volatility/plugins/overlays/linux/Ubuntu1404.zip $VOL_PROFILE_DIR/*
